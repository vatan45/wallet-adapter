...
var import_dist4, import_dist5, import_dist6, end_of_stream, finished, DEFAULT_ENCODING;
...
var import_dist10, import_dist11, import_dist12, getRandomValues, rnds8;
var init_rng = __esm({
  "node_modules/uuid/dist/esm-browser/rng.js"() {
...
var import_dist13, import_dist14, import_dist15, regex_default;
...
var import_dist16, import_dist17, import_dist18, validate_default;
...
var import_dist19, import_dist20, import_dist21, byteToHex, i, stringify_default;
...
var import_dist22, import_dist23, import_dist24, _nodeId, _clockseq, _lastMSecs, _lastNSecs, v1_default;
var init_v1 = __esm({
  "node_modules/uuid/dist/esm-browser/v1.js"() {
...
var import_dist25, import_dist26, import_dist27, parse_default;
...
var import_dist28, import_dist29, import_dist30, DNS, URL;
var init_v35 = __esm({
  "node_modules/uuid/dist/esm-browser/v35.js"() {
...
var import_dist31, import_dist32, import_dist33, md5_default;
var init_md5 = __esm({
  "node_modules/uuid/dist/esm-browser/md5.js"() {
...
var import_dist34, import_dist35, import_dist36, v3, v3_default;
var init_v3 = __esm({
  "node_modules/uuid/dist/esm-browser/v3.js"() {
...
var import_dist37, import_dist38, import_dist39, v4_default;
var init_v4 = __esm({
  "node_modules/uuid/dist/esm-browser/v4.js"() {
...
var import_dist40, import_dist41, import_dist42, sha1_default;
var init_sha1 = __esm({
  "node_modules/uuid/dist/esm-browser/sha1.js"() {
...
var import_dist43, import_dist44, import_dist45, v5, v5_default;
var init_v5 = __esm({
  "node_modules/uuid/dist/esm-browser/v5.js"() {
...
var import_dist46, import_dist47, import_dist48, nil_default;
var init_nil = __esm({
  "node_modules/uuid/dist/esm-browser/nil.js"() {
...
var import_dist49, import_dist50, import_dist51, version_default;
...
function weierstrassPoints(opts) {
  ...
  function isWithinCurveOrder(num2) {
    return inRange(num2, _1n2, CURVE.n);
  }
  function normPrivateKeyToScalar(key) {
    ...
    if (wrapPrivateKey)
      num2 = mod(num2, N);
    aInRange("private key", num2, _1n2, N);
    return num2;
  }
  ...
  class Point2 {
     ...
     */
    multiplyUnsafe(sc) {
      aInRange("scalar", sc, _0n2, CURVE.n);
      const I = Point2.ZERO;
      if (sc === _0n2)
        return I;
      if (sc === _1n2)
...
function weierstrass(curveDef) {
  ...
  class Signature {
    ...
    assertValidity() {
      aInRange("r", this.r, _1n2, CURVE_ORDER);
      aInRange("s", this.s, _1n2, CURVE_ORDER);
    }
  ...
  function int2octets(num2) {
    aInRange(`num < 2^${CURVE.nBitLength}`, num2, _0n2, ORDER_MASK);
...
function SWUFpSqrtRatio(Fp2, Z) {
  ...
  const c7 = Fp2.pow(Z, (c2 + _1n2) / _2n2);
  let sqrtRatio = (u, v) => {
    let tv1 = c6;
...
function lift_x(x) {
  aInRange("x", x, _1n3, secp256k1P);
  const xx = modP(x * x);
  const c = modP(xx * x + BigInt(7));
  let y = sqrtMod(c);
  if (y % _2n3 !== _0n3)
    y = modP(-y);
  const p = new Point(x, y, _1n3);
  p.assertValidity();
  return p;
}
...
function schnorrVerify(signature2, message, publicKey2) {
  ...
  try {
    ...
    if (!inRange(r, _1n3, secp256k1P))
      return false;
    const s = num(sig.subarray(32, 64));
    if (!inRange(s, _1n3, secp256k1N))
      return false;
...
@noble/curves/esm/secp256k1.js:
  (*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) *)
*/
//# sourceMappingURL=chunk-JDNDY5FK.js.map
